              ...
              >
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent className="text-xl">
                    ...
                    background and a square (1:1) ratio. The simplest versions
                    of the logo work best - black and white, or one color.
                    Background shouldnt be transparent. If you have a logo with
                    a transparent background, please add a white background
                    before uploading.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-4">
                  ...
                  <AccordionContent className="text-xl">
                    ...
                    if you require 1000 pictures, you can purchase two
                    500-picture plans. All will be added to your account. Please
                    note that your account is associated with your email.
                    Therefore, if you purchase a plan using a different email,
                    you will need to log in with that email to access your
                    credits.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-5">
                  ...
                  <AccordionContent className="text-xl">
                    ...
                    pictures generated are in a 1:1 ratio and have a resolution
                    of 768x768.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent className="text-xl">
                    ...
                    you are unsatisfied with the results, please contact us and
                    we will assist you in achieving the best results.
                  </AccordionContent>
                </AccordionItem>
